...
const linkedin_private_api_1 = __nccwpck_require__(2310);
class LinkedInClient {
    ...
    static create(username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = new linkedin_private_api_1.Client();
            yield client.login.userPass({
                username,
                password,
            });
    ...
    getNextConversations() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.conversationScroller.scrollNext();
        });
    }
    getMessages(conversationId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.message
                .getMessages({ conversationId })
                .scrollNext();
        });
    }
    sendMessage(profileId, text) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.message.sendMessage({
                profileId,
                text,
            });
        });
...
exports.default = LinkedInClient;
...
const readfile_1 = __nccwpck_require__(1384);
/**
 ...
 */
function getText(message, path) {
    if (message !== '') {
        return message;
    }
    else if (path !== '') {
        return (0, readfile_1.readFile)(path);
    }
    else {
 ...
 */
function getSinceTimestamp(since) {
    return (0, moment_1.default)().subtract(since, 'minutes').unix() * 1000;
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.filterConversation = exports.filterConversations = exports.getConversations = exports.SUBTYPE_INMAIL = void 0;
const core = __importStar(__nccwpck_require__(2186));
exports.SUBTYPE_INMAIL = 'INMAIL';
function getConversations(client, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const conversations = [];
        let i = 1;
        while (conversations.length < config.limit) {
            core.debug(`getConversations: getting page ${i} of conversations`);
            const next = yield client.getNextConversations();
            conversations.push(...next);
        }
        const filteredConversations = yield filterConversations(client, config, conversations);
        core.debug(`getConversations: ${filteredConversations.length} conversations to respond to`);
        return filteredConversations;
    });
}
exports.getConversations = getConversations;
function filterConversations(client, config, conversations) {
    return __awaiter(this, void 0, void 0, function* () {
        const conversationData = yield Promise.all(conversations.map((conversation) => __awaiter(this, void 0, void 0, function* () {
            const messages = yield client.getMessages(conversation.conversationId);
...
exports.filterConversations = filterConversations;
function filterConversation(config, data) {
    // Skip if there are more than one message
    if (data.messages.length > 1) {
        return false;
    }
    // Skip if it's not an inmail and we want to only respond to them
    if (config.inmailsOnly && data.messages[0].subtype !== exports.SUBTYPE_INMAIL) {
        return false;
    }
...
exports.filterConversation = filterConversation;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const Client_1 = __importDefault(__nccwpck_require__(7865));
const config_1 = __nccwpck_require__(88);
const conversation_1 = __nccwpck_require__(6911);
const message_1 = __nccwpck_require__(8101);
const utils_1 = __nccwpck_require__(918);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const config = (0, config_1.newConfig)();
            if (config instanceof Error) {
                core.debug(`could not build configuration`);
                throw config;
            }
            core.debug(`config ${JSON.stringify(Object.assign(Object.assign({}, config), { username: (0, utils_1.censorEmail)(config.username), password: '***' }))}`);
            core.debug(`connecting to LinkedIn`);
            const client = yield Client_1.default.create(config.username, config.password);
            const conversations = yield (0, conversation_1.getConversations)(client, config);
            const sent = yield (0, message_1.sendMessages)(client, config, conversations);
...
const core = __importStar(__nccwpck_require__(2186));
const utils_1 = __nccwpck_require__(918);
function sendMessages(client, config, conversations) {
    return __awaiter(this, void 0, void 0, function* () {
        const sent = [];
        try {
            for (const conversation of conversations) {
                const participant = (0, utils_1.getFirstParticipant)(conversation);
                const name = (0, utils_1.getName)(participant);
                const profileId = (0, utils_1.getProfileId)(participant);
                core.debug(`sendMessage: sending message to ${name}`);
                if (!config.dryRun) {
                    yield client.sendMessage(profileId, config.text);
                    sent.push(name);
                }
            }
            return sent;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.censorEmail = exports.censorWord = exports.getName = exports.getProfileId = exports.getFirstParticipant = void 0;
function getFirstParticipant(conversation) {
    return conversation.participants[0];
}
exports.getFirstParticipant = getFirstParticipant;
function getProfileId(miniProfile) {
    return miniProfile.profileId;
}
exports.getProfileId = getProfileId;
function getName(miniProfile) {
...
function censorEmail(email) {
    ...
    return (censorWord(username) + '@' + censorWord(subdomain) + '.' + tlds.join('.'));
}
...
const repositories_1 = __nccwpck_require__(1192);
const linkedin_request_1 = __nccwpck_require__(731);
const login_1 = __nccwpck_require__(7007);
class Client {
    constructor() {
...
const auth_request_1 = __nccwpck_require__(548);
const conversation_request_1 = __nccwpck_require__(3169);
const invitation_request_1 = __nccwpck_require__(9203);
const message_request_1 = __nccwpck_require__(7271);
const profile_request_1 = __nccwpck_require__(6662);
const search_request_1 = __nccwpck_require__(3307);
const request_1 = __nccwpck_require__(2759);
...
const cookie_1 = __nccwpck_require__(3658);
const fs = __importStar(__nccwpck_require__(9225));
const lodash_1 = __nccwpck_require__(250);
const config_1 = __nccwpck_require__(1421);
...
const config_1 = __nccwpck_require__(1421);
const paramsSerializer_1 = __nccwpck_require__(3413);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=company-search-hit.entity.js.map
...
__exportStar(__nccwpck_require__(9890), exports);
__exportStar(__nccwpck_require__(3285), exports);
__exportStar(__nccwpck_require__(1160), exports);
__exportStar(__nccwpck_require__(8590), exports);
__exportStar(__nccwpck_require__(5356), exports);
__exportStar(__nccwpck_require__(3415), exports);
...
__exportStar(__nccwpck_require__(9298), exports);
__exportStar(__nccwpck_require__(6631), exports);
__exportStar(__nccwpck_require__(4659), exports);
__exportStar(__nccwpck_require__(2007), exports);
__exportStar(__nccwpck_require__(5425), exports);
__exportStar(__nccwpck_require__(8531), exports);
__exportStar(__nccwpck_require__(9906), exports);
__exportStar(__nccwpck_require__(2813), exports);
__exportStar(__nccwpck_require__(3407), exports);
__exportStar(__nccwpck_require__(9940), exports);
__exportStar(__nccwpck_require__(5249), exports);
__exportStar(__nccwpck_require__(164), exports);
__exportStar(__nccwpck_require__(4034), exports);
__exportStar(__nccwpck_require__(6270), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-attribute-text.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BASE_COMPANY_TYPE = void 0;
exports.BASE_COMPANY_TYPE = 'com.linkedin.voyager.organization.Company';
//# sourceMappingURL=linkedin-base-company.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-collection-response.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.COMPANY_TYPE = void 0;
exports.COMPANY_TYPE = 'com.linkedin.voyager.dash.organization.Company';
//# sourceMappingURL=linkedin-company.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CONVERSATION_TYPE = exports.FeaturedType = void 0;
var FeaturedType;
(function (FeaturedType) {
    FeaturedType[FeaturedType["REACTIONS"] = 0] = "REACTIONS";
    FeaturedType[FeaturedType["CREATE_NEW_GROUP_CHAT"] = 1] = "CREATE_NEW_GROUP_CHAT";
})(FeaturedType = exports.FeaturedType || (exports.FeaturedType = {}));
exports.CONVERSATION_TYPE = 'com.linkedin.voyager.messaging.Conversation';
//# sourceMappingURL=linkedin-conversation.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-event-create-response.js.map
...
exports.EVENT_TYPE = 'com.linkedin.voyager.messaging.Event';
//# sourceMappingURL=linkedin-event.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-image-attribute.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-image-view-model.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.INVITATION_TYPE = void 0;
var InvitationType;
(function (InvitationType) {
    InvitationType[InvitationType["PENDING"] = 0] = "PENDING";
    InvitationType[InvitationType["SENT"] = 1] = "SENT";
})(InvitationType || (InvitationType = {}));
exports.INVITATION_TYPE = 'com.linkedin.voyager.relationships.invitation.Invitation';
//# sourceMappingURL=linkedin-invitation.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.JOB_POSTING_TYPE = void 0;
exports.JOB_POSTING_TYPE = 'com.linkedin.voyager.jobs.JobPosting';
//# sourceMappingURL=linkedin-job-posting.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-message-event.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-message.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MINI_COMPANY_TYPE = void 0;
exports.MINI_COMPANY_TYPE = 'com.linkedin.voyager.entities.shared.MiniCompany';
//# sourceMappingURL=linkedin-mini-company.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MINI_PROFILE_TYPE = void 0;
exports.MINI_PROFILE_TYPE = 'com.linkedin.voyager.identity.shared.MiniProfile';
//# sourceMappingURL=linkedin-mini-profile.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PROFILE_TYPE = void 0;
exports.PROFILE_TYPE = 'com.linkedin.voyager.dash.identity.profile.Profile';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-quick-replay-recommendation.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-search-cluster.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-search-hit-v2.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-vector-artifact.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=linkedin-vector-image.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=message-create-response.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=message-event.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=mini-profile.entity.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=people-search-hit.entity.js.map
...
__exportStar(__nccwpck_require__(7459), exports);
__exportStar(__nccwpck_require__(6950), exports);
...
const lodash_1 = __nccwpck_require__(250);
const linkedin_conversation_entity_1 = __nccwpck_require__(5356);
const conversation_scroller_1 = __nccwpck_require__(3968);
const profile_repository_1 = __nccwpck_require__(453);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(3058), exports);
...
__exportStar(__nccwpck_require__(458), exports);
//# sourceMappingURL=index.js.map
...
const lodash_1 = __nccwpck_require__(250);
const linkedin_invitation_entity_1 = __nccwpck_require__(3835);
const scrollers_1 = __nccwpck_require__(2670);
const profile_repository_1 = __nccwpck_require__(453);
...
const lodash_1 = __nccwpck_require__(250);
const linkedin_event_entity_1 = __nccwpck_require__(2507);
const scrollers_1 = __nccwpck_require__(2670);
const profile_repository_1 = __nccwpck_require__(453);
const participantToProfileId = (participant) => participant.replace(/urn:li:fs_messagingMember:\(|\)/g, '').split(',')[1];
...
const lodash_1 = __nccwpck_require__(250);
const linkedin_company_entity_1 = __nccwpck_require__(8590);
const linkedin_mini_profile_entity_1 = __nccwpck_require__(2007);
const linkedin_profile_entity_1 = __nccwpck_require__(5425);
...
const lodash_1 = __nccwpck_require__(250);
const linkedin_mini_company_entity_1 = __nccwpck_require__(4659);
const company_search_scroller_1 = __nccwpck_require__(4774);
const people_search_scroller_1 = __nccwpck_require__(2094);
const job_search_scroller_1 = __nccwpck_require__(3391);
const network_enum_1 = __nccwpck_require__(7298);
const search_result_type_enum_1 = __nccwpck_require__(3626);
const search_type_enum_1 = __nccwpck_require__(8137);
const profile_repository_1 = __nccwpck_require__(453);
const linkedin_job_posting_1 = __nccwpck_require__(5440);
const linkedin_base_company_1 = __nccwpck_require__(8945);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=blended-search.reponse.get.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=conversation.response.get.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=conversations.response.get.js.map
...
__exportStar(__nccwpck_require__(9640), exports);
__exportStar(__nccwpck_require__(6802), exports);
__exportStar(__nccwpck_require__(2547), exports);
__exportStar(__nccwpck_require__(5161), exports);
__exportStar(__nccwpck_require__(4405), exports);
__exportStar(__nccwpck_require__(7097), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=messages.response.get.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=own-profile.response.get.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=profile.response.get.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=received-invitations.response.get.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=sent-invitations.response.get.js.map
...
const skip_limit_scroller_1 = __nccwpck_require__(9501);
...
const lodash_1 = __nccwpck_require__(250);
const created_before_scroller_1 = __nccwpck_require__(7756);
...
__exportStar(__nccwpck_require__(8884), exports);
__exportStar(__nccwpck_require__(2094), exports);
__exportStar(__nccwpck_require__(3391), exports);
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=anonymous-cookies.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=blended-search-filters.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LinkedInContractInterest = void 0;
var LinkedInContractInterest;
(function (LinkedInContractInterest) {
    LinkedInContractInterest["PRO_BONO"] = "proBono";
    LinkedInContractInterest["BOARD_MEMBER"] = "boardMember";
})(LinkedInContractInterest = exports.LinkedInContractInterest || (exports.LinkedInContractInterest = {}));
//# sourceMappingURL=contract-interest.enum.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(5728), exports);
__exportStar(__nccwpck_require__(2012), exports);
__exportStar(__nccwpck_require__(6526), exports);
...
__exportStar(__nccwpck_require__(7298), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LinkedInNetworkType = void 0;
var LinkedInNetworkType;
(function (LinkedInNetworkType) {
    LinkedInNetworkType["F"] = "F";
    LinkedInNetworkType["S"] = "S";
    LinkedInNetworkType["O"] = "O";
})(LinkedInNetworkType = exports.LinkedInNetworkType || (exports.LinkedInNetworkType = {}));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
//# sourceMappingURL=people-search-filters.js.map
...
(function (SearchResultType) {
    SearchResultType["SEARCH_HITS"] = "SEARCH_HITS";
    SearchResultType["SEARCH_FEATURES"] = "SEARCH_FEATURES";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LinkedInSearchType = void 0;
var LinkedInSearchType;
(function (LinkedInSearchType) {
    LinkedInSearchType["PEOPLE"] = "PEOPLE";
    LinkedInSearchType["COMPANIES"] = "COMPANIES";
    LinkedInSearchType["JOBS"] = "JOBS";
})(LinkedInSearchType = exports.LinkedInSearchType || (exports.LinkedInSearchType = {}));
//# sourceMappingURL=search-type.enum.js.map
